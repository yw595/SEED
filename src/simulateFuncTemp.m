		...
		if mergeModelsAGORAFlag
			...
			if useFBA==0
				...
				expressionData = species1expr;
			        ...
			        species1expr = importdata([inputDir filesep 'MGMData/' ucrFolder filesep AGORAModel1.description AGORAModel2.description 'speciesSep' num2str(i) '.modelexpr']);
                                species2expr = importdata([inputDir filesep 'MGMData/' ucrFolder filesep AGORAModel1.description AGORAModel2.description 'species' num2str(j) '.modelexpr']);
				expressionData = species1expr;			      
			    end
			else
